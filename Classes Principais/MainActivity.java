...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnSalvar, btnAtualizar, btnSelecionar,btnSelTodos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSelTodos = (Button) findViewById(R.id.btnSelTodos);
        ...
        //Evento do botao SelTodos
        btnSelTodos.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
    ...
    public void selecionarUnico()
    {
        try
        {
            ...
            mens = "Mat.:" + listaAluno.get(0).getMatricula()+
                   "Nome:"+ listaAluno.get(0).getNome()+
                   "Curso:"+ listaAluno.get(0).getCurso();
